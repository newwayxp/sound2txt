...
_T: dict[str, dict[str, str]] = {
    ...
    "final_dir":     {"zh": "在线精修保存目录",           "ja": "オンライン精緻化の保存先",       "en": "Online-refined directory"},
    "term_dir":      {"zh": "术语缓存目录",               "ja": "用語キャッシュ保存先",           "en": "Term cache directory"},
    "vocab_file":    {"zh": "词汇表文件（.txt）",          "ja": "ボキャブラリファイル（.txt）",   "en": "Vocabulary file (.txt)"},
    "glossary_file": {"zh": "术语表文件（.txt）",          "ja": "用語辞書ファイル（.txt）",       "en": "Glossary file (.txt)"},
    ...
    "online_refine": {"zh": "停止后在线行业术语精修",       "ja": "停止後にオンライン業界用語で精修", "en": "Online industry-term refinement after stop"},
    "online_refine_hint":{"zh": "判断会议领域，下载术语候选，生成独立 final_corrected 文件；原文件保留。",
                           "ja": "会議分野を推定し、用語候補を取得して final_corrected を別保存します。元ファイルは保持します。",
                           "en": "Infer the meeting domain, fetch term candidates, and save a separate final_corrected file; originals are kept."},
    ...
    "tab_corrected": {"zh": "✏️  校正结果",              "ja": "✏️  校正済み",                   "en": "✏️  Corrected"},
    ...
    "corrected_hint":     {"zh": "校正后的文字将实时显示在这里（应用了词汇表与术语表）。",
                           "ja": "校正後のテキストがここにリアルタイムで表示されます（ボキャブラリ・用語辞書を適用）。",
                           "en": "Corrected text (vocabulary & glossary applied) will appear here in real time."},
