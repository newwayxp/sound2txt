...
echo "=== Setup complete ==="
echo ""
echo "IMPORTANT: Configure BlackHole for system audio capture"
echo "─────────────────────────────────────────────────────────"
echo "Meeting mode (capture both speakers + mic):"
...
echo "  4. System Settings → Sound → Output → select the Multi-Output Device"
echo ""
echo "Local Mic mode: no extra configuration needed."
echo ""
echo "To start: $PY ui_qt.py"
